...
- Start a PostgreSQL container named `my-market-postgres`
- Create a database named `mymarket`
...
You should see a container named `my-market-postgres` running.
...
```
DATABASE_URL=postgresql://Vladimir:Vladimir123@localhost:5432/mymarket
```
