...
export async function seedProductImages() {
  ...
  const fakeImages = [
    // Organic Tomatoes - multiple images
    {
      ...
      sortOrder: 0,
      altText: 'Fresh organic tomatoes on the vine',
    },
    {
      productId: findProduct('organic-tomatoes').id,
      url: 'https://images.unsplash.com/photo-1592924357228-91a4daadcfea?w=800',
      sortOrder: 1,
      altText: 'Close-up of organic tomatoes',
    },
    // Fresh Lettuce Mix
    {
      ...
      sortOrder: 0,
      altText: 'Fresh mixed lettuce leaves',
    },
    {
      productId: findProduct('fresh-lettuce-mix').id,
      url: 'https://images.unsplash.com/photo-1588168333986-5078d3ae3976?w=800',
      sortOrder: 1,
      altText: 'Fresh lettuce mix in basket',
    },
    // Organic Carrots
    {
      ...
      sortOrder: 0,
      altText: 'Fresh organic carrots with green tops',
    },
    {
      productId: findProduct('organic-carrots').id,
      url: 'https://images.unsplash.com/photo-1598170845058-32b9d6a5da37?w=800',
      sortOrder: 1,
      altText: 'Organic carrots close-up',
    },
    // Fresh Whole Milk
    {
      ...
      sortOrder: 0,
      altText: 'Fresh whole milk bottle',
    },
    // Artisan Cheese Selection
    {
      ...
      sortOrder: 0,
      altText: 'Assortment of artisan cheeses',
    },
    {
      productId: findProduct('artisan-cheese-selection').id,
      url: 'https://images.unsplash.com/photo-1552767059-ce182ead6c1b?w=800',
      sortOrder: 1,
      altText: 'Cheese board with various cheeses',
    },
    // Free-Range Chicken Eggs
    {
      ...
      sortOrder: 0,
      altText: 'Fresh free-range chicken eggs',
    },
    {
      productId: findProduct('free-range-chicken-eggs').id,
      url: 'https://images.unsplash.com/photo-1588168333986-5078d3ae3976?w=800',
      sortOrder: 1,
      altText: 'Brown and white free-range eggs',
    },
    // Grass-Fed Ground Beef
    {
      ...
      sortOrder: 0,
      altText: 'Fresh grass-fed ground beef',
    },
    // Organic Strawberries
    {
      ...
      sortOrder: 0,
      altText: 'Fresh organic strawberries',
    },
    {
      productId: findProduct('organic-strawberries').id,
      url: 'https://images.unsplash.com/photo-1518635017498-87f514b751ba?w=800',
      sortOrder: 1,
      altText: 'Ripe organic strawberries in basket',
    },
    // Sourdough Bread
    {
      ...
      sortOrder: 0,
      altText: 'Fresh baked sourdough bread',
    },
    {
      productId: findProduct('sourdough-bread').id,
      url: 'https://images.unsplash.com/photo-1549931319-a545dcf3bc73?w=800',
      sortOrder: 1,
      altText: 'Sliced sourdough bread on cutting board',
    },
    // Local Honey
    {
      ...
      sortOrder: 0,
      altText: 'Jar of golden local honey',
    },
    {
      productId: findProduct('local-honey').id,
      url: 'https://images.unsplash.com/photo-1558642452-9d2a7deb7f62?w=800',
      sortOrder: 1,
      altText: 'Honey being poured from jar',
    },
  ]
  ...
  insertedImages.forEach((image) => {
    console.log(`   - Image: ${image.altText || 'No alt text'}`)
  })
